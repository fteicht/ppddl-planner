...
#ifndef GRAPH_IMPROVED_LAO_H_
#define GRAPH_IMPROVED_LAO_H_

#include <set>
#include "heuristic_algorithm.h"

class GraphImprovedLAO : public GraphHeuristicAlgorithm<GraphStateWT<> >
{
public :
...
public :
	...
	GraphImprovedLAO(const Problem& pb, double epsilon, double discount_factor, unsigned int plan_length, heuristic_t heuristic_type,
						determinization_t determinization_type, deterministic_planner_t deterministic_planner_type); // throws

	/* Destructs this algorithm */
	virtual ~GraphImprovedLAO() {}
