...
#ifndef SYMBOLIC_LAO_H_
#define SYMBOLIC_LAO_H_

#include "heuristic_algorithm.h"

class SymbolicLAO : public SymbolicHeuristicAlgorithm
{
private :
...
public :
	...
	SymbolicLAO(const Problem& pb, double epsilon, double discount_factor, unsigned int plan_length, heuristic_t heuristic_type,
