...
#ifndef GRAPH_FSP_STAR_H_
#define GRAPH_FSP_STAR_H_

#include <set>
#include "heuristic_algorithm.h"

class GraphFSPstar : public GraphHeuristicAlgorithm<GraphStateWT<> >
{
public :
...
public :
	...
	GraphFSPstar(const Problem& pb, double epsilon, double discount_factor, unsigned int plan_length, heuristic_t heuristic_type,
					determinization_t determinization_type, deterministic_planner_t deterministic_planner_type); // throws

	/* Destructs this algorithm */
	virtual ~GraphFSPstar() {}
