...
#ifndef GRAPH_MVHO_H_
#define GRAPH_MVHO_H_

#include "base_algorithm.h"
#include "models/graph_mdp.h"

/**
 * Mean-variance approximate optimization
 */
template <typename Tstate>
class GraphMVHO : public GraphAlgorithm<Tstate>
{
protected :
	...
	/**
	 * Minimize the variance at the current mean level
	 */
...
public :
	/* Constructs a MVHO algorithm */
	GraphMVHO(const Problem& pb, double minimum_mean, double maximum_variance, double epsilon, double discount_factor); // throws
