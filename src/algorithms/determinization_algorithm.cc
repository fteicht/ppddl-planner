...
DeterminizationAlgorithm::DeterminizationAlgorithm(const Problem& pb, double epsilon, double discount_factor, unsigned int plan_length, determinization_t determinization_type, deterministic_planner_t deterministic_planner_type)
try : BaseAlgorithm(pb, epsilon, discount_factor), determinization_type_(determinization_type), deterministic_planner_type_(deterministic_planner_type)
{
...
{
	error.push_function_backtrace("DeterminizationAlgorithm::DeterminizationAlgorithm");
	throw;
}
