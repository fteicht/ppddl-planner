...
class GraphFSP : public GraphHeuristicAlgorithm<GraphStateWTA<> >
{
public :
...
public :
	...
	GraphFSP(const Problem& pb, double epsilon, double discount_factor, unsigned int plan_length, heuristic_t heuristic_type,
