...
#ifndef DETERMINIZATION_ALGORITHM_H_
#define DETERMINIZATION_ALGORITHM_H_
...
class DeterminizationAlgorithm : public virtual BaseAlgorithm
{
protected :
...
public :
	/* Constructs a determinization algorithm */
	DeterminizationAlgorithm(const Problem& pb, double epsilon, double discount_factor, unsigned int plan_length, determinization_t determinization_type, deterministic_planner_t deterministic_planner_type); // throws

	/* Deletes this determinization algorithm */
	virtual ~DeterminizationAlgorithm();
...
#endif /*DETERMINIZATION_ALGORITHM_H_*/
