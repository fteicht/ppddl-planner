...
struct Term {
  ...
  /* Prints with type */
  void print_with_type(std::ostream& os) const;
...
struct TermTable {
  ...
  /* Returns the objects of this term table */
  inline const std::map<std::string, Object>& get_objects() const {return objects_;}
