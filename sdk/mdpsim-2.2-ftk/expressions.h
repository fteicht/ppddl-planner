...
struct Fluent : public Expression {
  ...
  /* Returns the fluent associated with the given function, or NULL if no fluent is associated with it */
  static const Fluent* fluent(const Function& fun);
  ...
  /* Returns the table of grounded fluents */
  static const FluentTable& fluent_table() {return fluents;}
  
  /* Returns the number of grounded fluents (added by Florent Teichteil-Koenigsbuch) */
  static const unsigned int& number_of_fluents() {return number_of_fluents_;}
  
  /* Returns the fluent index if grounded, UINT_MAX otherwise (added by Florent Teichteil-Koenigsbuch) */
 ...
 private:
  /* Table of grounded fluents. */
  static FluentTable fluents;
  
  /* Number of grounded fluents (added by Florent Teichteil-Koenigsbuch) */
  static unsigned int number_of_fluents_;
  
  /* Fluent index if grounded, UINT_MAX otherwise (added by Florent Teichteil-Koenigsbuch) */
  unsigned int index_;
