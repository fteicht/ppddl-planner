...
struct Rational {
  ...
  /* Prints rational numbers as a double values or as a fractions (default is fractions) */
  static void print_double(bool asDouble) {asDouble_ = asDouble;}

  /* Should rational numbers be printed as a double values or as fractions? */
  static bool print_double() {return asDouble_;}
 ...
 private:
  ...
  /* The denominator. */
  int denominator_;
  /* Prints the rational number as a double value or as a fraction */
  static bool asDouble_;
};
