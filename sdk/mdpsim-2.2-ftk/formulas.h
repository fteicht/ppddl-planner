...
struct Atom : public StateFormula {
  ...
  /* Returns the table of grounded atoms */
  static const AtomTable& atom_table() {return atoms;}
  
  /* Returns the number of grounded atoms (added by Florent Teichteil-Koenigsbuch) */
  static const unsigned int& number_of_atoms() {return number_of_atoms_;}
  
  /* Returns the atom index if grounded, UINT_MAX otherwise (added by Florent Teichteil-Koenigsbuch) */
  const unsigned int& index() const {return index_;}
 ...
 private:
  ...
  /* Number of grounded atoms (added by Florent Teichteil-Koenigsbuch) */
  static unsigned int number_of_atoms_;
  
  /* Atom index if grounded, UINT_MAX otherwise (added by Florent Teichteil-Koenigsbuch) */
  unsigned int index_;
